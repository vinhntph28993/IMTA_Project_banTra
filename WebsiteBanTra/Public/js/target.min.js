...
$(function () {
    $('#buy-btn').off('click').on('click', function (e) {
        e.preventDefault();
        var count = $('input[name="count-xyz"]').val();
        if ($('.etd').val() >= count) {
            alert("Số lượng vượt quá số lượng cho phép. Vui lòng mua với số lượng ít hơn số lượng có sẵn!")
        }
        else {
            $.ajax({
                url: 'cart/add',
            ...
            success: function (f) {
                if (f.f == 0) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            Email: $('input[name=EmailOrder]').val(),
                            Phone: $('input[name=Phone]').val(),
                            Address: $('input[name=AddressOrder]').val(),
                            FullName: $('input[name=FullName]').val(),
                            CodeVoucher: $('input[name=Voucher]').val(),
                        },
                        dataType: 'json',
